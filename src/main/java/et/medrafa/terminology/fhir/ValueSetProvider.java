package et.medrafa.terminology.fhir;
...
import et.medrafa.terminology.domain.FHIRCodeSystem;
import et.medrafa.terminology.domain.FHIRConcept;
import et.medrafa.terminology.domain.FHIRDescription;
import et.medrafa.terminology.domain.LanguageDialect;
import et.medrafa.terminology.domain.valueset.FHIRValueSet;
import et.medrafa.terminology.service.CodeSystemRepository;
import et.medrafa.terminology.service.ValueSetService;
...
import static et.medrafa.terminology.fhir.FHIRConstants.ACCEPT_LANGUAGE_HEADER;
import static et.medrafa.terminology.fhir.FHIRConstants.SNOMED_URI;
import static et.medrafa.terminology.fhir.FHIRHelper.*;
...
public class ValueSetProvider implements IResourceProvider {
	...
	public Parameters validateCodeExplicit(
		...
		// Grab 'the' CodeSystem (only one in Terminology)
