...
public record FHIRSnomedImplicitMap(String refsetId, String name, String sourceSystem, String targetSystem, Enumerations.ConceptMapEquivalence equivalence) {
