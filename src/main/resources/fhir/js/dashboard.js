...
function createDashboardState() {
	return {
		...
		settingsCustomCodeSystems: 0,
		settingsCustomValueSets: 0,
		settingsCustomConceptMaps: 0,
		settingsCustomTotal: 0,
		settingsCustomCountsLoading: false,
		settingsCustomCountsLoaded: false,
