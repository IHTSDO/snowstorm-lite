...
class CorsTest {
    ...
    void testCorsHeadersForFhirCodeSystem() {
        ...
        System.out.println("STATUS WAS: " + response.getStatusCode()); assertTrue(response.getStatusCode().is2xxSuccessful() || response.getStatusCode() == HttpStatus.NOT_FOUND || response.getStatusCode() == HttpStatus.CONFLICT,
